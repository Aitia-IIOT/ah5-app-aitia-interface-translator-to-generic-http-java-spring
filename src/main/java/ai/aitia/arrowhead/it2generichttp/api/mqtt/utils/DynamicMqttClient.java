 ...
 *
 *******************************************************************************/
package ai.aitia.arrowhead.it2generichttp.api.mqtt.utils;
...
import ai.aitia.arrowhead.it2generichttp.api.mqtt.DynamicMqttCallback;
...
public class DynamicMqttClient {
	...
	public String getServerURI() {
		...
		return sysInfo.isMqttBridgeEnabled() && client != null ? client.getServerURI() : "";
	}
	...
	private MqttClient createAndConnect() throws MqttException {
		...
		final MqttClient client = new MqttClient(serverURI, InterfaceTranslatorToGenericHTTPConstants.MQTT_BRIDGE_BROKER_CONNECT_ID);
