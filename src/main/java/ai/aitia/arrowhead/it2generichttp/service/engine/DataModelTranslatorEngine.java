...
public class DataModelTranslatorEngine {
	...
	@Value(InterfaceTranslatorToGenericHTTPConstants.$DATA_MODEL_TRANSLATOR_GET_RESULT_TRIES_WD)
	private int defaultGetResultRetries;

	@Value(InterfaceTranslatorToGenericHTTPConstants.$DATA_MODEL_TRANSLATOR_GET_RESULT_WAIT_WD)
