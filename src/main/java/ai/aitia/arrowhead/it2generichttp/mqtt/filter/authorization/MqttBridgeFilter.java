 ...
 *
 *******************************************************************************/
package ai.aitia.arrowhead.it2generichttp.mqtt.filter.authorization;
...
public class MqttBridgeFilter implements ArrowheadMqttFilter {
	...
	public void doFilter(final String authInfo, final MqttRequestModel request) {
		...
		if (request.getBaseTopic().startsWith(InterfaceTranslatorToGenericHTTPConstants.MQTT_DYNAMIC_BASE_TOPIC_PREFIX)
